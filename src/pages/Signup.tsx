  ...
  return (
    <div className="min-h-screen bg-[#faf9ff] flex overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#3d3151] relative p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 space-y-12">
          <div className="space-y-4">
            <h2 className="text-5xl font-extrabold text-white leading-tight font-display tracking-tight">
              Start your journey <br /> to <span className="text-[#ec8c6b] italic">effortless</span> teaching.
            </h2>
            <p className="text-white/60 text-xl font-medium max-w-md">Join 5,000+ teachers transforming the classroom experience with AI.</p>
          </div>
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={i} className="flex gap-4">
                <div className="w-6 h-6 rounded-full bg-[#6b5ea7]/20 border border-[#6b5ea7]/40 flex items-center justify-center shrink-0 mt-1">
                  <ArrowRight className="w-3 h-3 text-[#6b5ea7]" />
                </div>
                <div>
                  <h4 className="font-bold text-white text-sm">{item.title}</h4>
                  <p className="text-white/40 text-xs font-bold leading-relaxed">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="relative z-10 flex items-center gap-4 py-8 px-6 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 max-w-sm">
          <div className="flex -space-x-3">
            {[1, 2, 3, 4].map(i => (
              <div key={i} className="w-10 h-10 rounded-full border-2 border-[#3d3151] bg-[#6b5ea7] flex items-center justify-center text-[10px] font-bold text-white uppercase shadow-sm">User</div>
            ))}
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12 lg:p-24 relative overflow-y-auto">
        ...
        >
          <div>
            <h1 className="text-4xl font-black text-[#3d3151] tracking-tight leading-tighter">Create your teacher account</h1>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <Button type="submit" className="w-full h-14 rounded-2xl bg-[#6b5ea7] hover:bg-[#3d3151] text-white text-lg font-bold shadow-xl shadow-purple-100 transition-all font-bold" disabled={isLoading}>
              {isLoading ? (
          ...
          <div className="text-center">
            <p className="text-slate-500 font-bold">
              ...
              <Link to="/login" className="text-[#6b5ea7] hover:underline font-black italic">Sign in</Link>
            </p>
          </div>
        </motion.div>
      </div>
